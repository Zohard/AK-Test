...
export class ReportContentDto {
  ...
  @ApiProperty({ 
    ...
    enum: ['inappropriate_content', 'spam', 'copyright_violation', 'false_information', 'harassment', 'other'] 
  })
  @IsString()
  @IsIn(['inappropriate_content', 'spam', 'copyright_violation', 'false_information', 'harassment', 'other'])
  reason: string;
