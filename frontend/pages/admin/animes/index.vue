  ...
  <div class="admin-animes">
    ...
    <div class="page-header">
      ...
      <div class="page-header-right">
        <NuxtLink to="/admin/animes/new" class="btn btn-primary">
        ...
        <tbody>
          <tr v-for="anime in animes" :key="anime.id_anime" class="table-row">
            ...
            <td class="actions-cell">
              <button @click="editAnime(anime)" class="action-btn edit-btn">
                ✏️
              </button>
    ...
    <div v-else class="empty-state">
      ...
      <NuxtLink v-if="!searchQuery" to="/admin/animes/new" class="btn btn-primary">
        Ajouter un anime
      </NuxtLink>
    </div>
